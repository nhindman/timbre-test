define(function(require, exports, module) {
    ...
    var createBacking = function() {
        var backSurface = new Surface({
            size: [320, 164],
            content: '<img width="320" src="./img/band.png"/>'
        });
    ...
    var createNoteworthy = function() {
        ...
        var modifier = new Modifier({
            transform: Transform.move(Transform.rotateZ(this.options.angle), [this.options.xOffset, 30, 0])
        });
    ...
    var createStaffPicks = function() {
        ...
        var modifier = new Modifier({
            transform: Transform.move(Transform.rotateZ(this.options.angle), [this.options.xOffset, 67, 0])
        });
